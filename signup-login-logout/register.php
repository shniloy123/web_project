      ...
      <div class="col-lg-5">
        <div class="form-wrap border rounded p-4">
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            ...
            <div class="mb-3">
              <input type="submit" class="btn btn-primary form-control" name="submit" value="Sign Up"><br><br>
              <a href="../timevento.php"><input type="button" class="btn btn-primary form-control" name="submit" value="Go TO Home"></a>
            </div>
          </form>
          <!-- form ends here -->
        </div>
