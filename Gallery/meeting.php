...
<head>
    ...
    <header>
        <a href="#" class="logo">
            <img src="img/iamges/timevent.png" alt="my website logo">
        </a>
...
<body>
    <div class="blog-img">
        <img src="img/meeting.png" alt="blog">
      </div>
      <!--text--->
      <div class="blog-text">
        <span style="text-align: center;">18 July 2021</span><br><br>
        <strong class="blog-title">A Meeting Event Management</strong>
        
        <p>Streamline tons of time-consuming processes, including budgets, contacts, members, calls-for-papers and abstracts, appointments, exhibitors, and more.
            <br><br>   Why We are Best Event Planner Bangladesh?<br><br>
            1.Organizational Skills.<br><br>
            2.Networking Savvy.<br><br>
            3.Resilience and Adaptability.<br><br>
            4.A Basic Understanding of Events.<br><br>
            5.Unbridled Creativity.<br><br>
            6.Dedication to Client Service.<br><br>
        </p>
      </div>
